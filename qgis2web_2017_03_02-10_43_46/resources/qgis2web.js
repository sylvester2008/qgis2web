...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [13282559.466194, 2514834.835524, 13660112.614081, 2963988.011120], maxZoom: 28, minZoom: 1
    })
});
map.getView().fit([13282559.466194, 2514834.835524, 13660112.614081, 2963988.011120], map.getSize());
